...
from componentes.aba_visualizacao import AbaVisualizacao
from componentes.aba_visualizacao_lista import AbaVisualizacaoLista
...
class BibliotecaApp:
    ...
    def mostrar_janela_principal(self):
        ...
        # Aba Visualização da Árvore (todos visualizam)
        self.aba_visualizacao = AbaVisualizacao(self.notebook, self.sistema)
        self.notebook.add(self.aba_visualizacao, text="Visualização da Árvore")

        self.aba_visualizacao_lista = AbaVisualizacaoLista(self.notebook, self.sistema)
        self.notebook.add(self.aba_visualizacao_lista, text="Visualização Lista Usuários")
